...
public class ImageModelViewImplExtra extends ImageModelViewImpl implements ChangeListener {
  ...
  private final ImagePanel rgbHistogramPanel;
  ...
  public ImageModelViewImplExtra(ImageModelMap imageModelMap) {
    ...
    this.rgbHistogramPanel = createHistogramPanel(this.imageModelMap, "rgb");
  ...
  protected void refresh(String modelName) {
    ...
    this.rgbHistogramPanel.setImageToPaint(modelName);
    this.intensityHistogramPanel.setImageToPaint(modelName);
